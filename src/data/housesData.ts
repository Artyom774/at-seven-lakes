...
const housesData: IHouses[] = [
  ...
  },
  {
    ...
    cost: 9000,
    costName: CostNameType.PER_DAY,
    additionally: 'Зимой стоимость дома 6000 руб./сутки'
  },
  {
    title: '22а',
    type: HouseType.SAUNA,
  ...
  },
  {
    ...
    top: 144,
    images: images25,
    annotation: 'Летний трёхэтажный банкетный дом с отоплением и мангальной зоной',
    capacity: 30,
  ...
  },
  {
    ...
    top: 286,
    images: images27,
    annotation: 'Зимний/Летний дом из сруба с баней, с верандой и мангальной зоной',
    capacity: 14,
    description: `В аренду включено:
