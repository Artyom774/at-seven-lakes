...
const mainPageData: IMainPageData[] = [
  ...
  },
  {
    ...
    decription: 'Чтобы загородный отдых был насыщенным и полезным для здоровья, разнообразьте его посещением русской бани на дровах.',
    image: photo3,
  },
  {
  ...
  },
  {
    ...
    decription: `Для рыбаков в летнее время выставляются понтоны.
      В зимнее время для рыбалки предлагаются услуги мотособаки.
  ...
  },
  {
    ...
    decription: `Наш клуб – это идеальное место для проведения активных интересных корпоративов.
      Для проведения корпоративного отдыха предлагается гостевой дом №25 с банкетным залом до 60 гостей.`,
    image: photo6,
  },
  {
    title: 'Летний отдых',
